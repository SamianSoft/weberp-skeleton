describe('Login page', function() {
  it('Should be able to login with default parameters into English dashboard', function() {
    ...
    cy.intercept('GET', '/v2/account/erpweb/profile?withRelation=true', {
      fixture: 'mock/auth/02-login-en/get/profile-en.json',
    }).as('profileGet');
    ...
    cy.get('#react-admin-title').should('contain', 'Home');
  });
});
